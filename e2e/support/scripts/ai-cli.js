...
function systemPrompt() {
  return [
    ...
    '  When verify "<name>" button is present on the screen',
    '  When verify "<name>" button is not present on the screen',
    '  When verify "<name>" Radio button is present on the screen',
    '  When verify "<name>" Radio button is not present on the screen',
    '  When verify "<name>" Radio button is selected',
    '  When verify "<name>" Radio button is not selected',
    '',
    'Hard rules:',
